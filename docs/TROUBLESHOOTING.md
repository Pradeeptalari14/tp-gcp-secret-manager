# 🔧 Troubleshooting Guide — GCP Secret Manager Studio
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-gcp-secret-manager/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/gcp-secret-manager/)
